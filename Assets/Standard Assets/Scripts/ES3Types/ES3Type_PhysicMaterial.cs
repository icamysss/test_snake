...
namespace ES3Types
{
	...
	public class ES3Type_PhysicMaterial : ES3ObjectType
	{
		...
		{
			PhysicsMaterial physicMaterial = (PhysicsMaterial)obj;
			...
			try
			{
				while (enumerator.MoveNext())
				{
					...
					case "frictionCombine":
						physicMaterial.frictionCombine = reader.Read<PhysicsMaterialCombine>();
						break;
					case "bounceCombine":
						physicMaterial.bounceCombine = reader.Read<PhysicsMaterialCombine>();
						break;
					default:
						reader.Skip();
						break;
